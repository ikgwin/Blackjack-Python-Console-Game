...
while game_on:
    ...
    player_chips = Chips()
    print("\nYou current have {} chips.".format(player_chips.total))

    # Promting player for their bet
    take_bet(player_chips)

    # Show cards (keeping on dealer card hidden)
    ...
    while playing:
        ...
        # Showing cards while keeping one of the dealers cards hidden
        show_some(player_hand, dealer_hand)
    ...
    # If player hasnt buster, player Dealers hand until dealer reaches 17
    if player_hand.value <= 21:
